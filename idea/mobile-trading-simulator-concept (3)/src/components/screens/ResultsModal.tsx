...
export const ResultsModal: React.FC = () => {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/85 backdrop-blur-md flex items-center justify-center p-3 animate-fadeIn select-none">
      <div className="bg-[#091522] border border-cyan-400/40 rounded-2xl max-w-md w-full p-4 sm:p-6 shadow-2xl relative overflow-hidden">
        {/* Background glow */}
        ...
        <div className="relative z-10 my-4 bg-black/50 border border-white/10 rounded-xl p-3.5 flex items-center justify-between gap-4">
