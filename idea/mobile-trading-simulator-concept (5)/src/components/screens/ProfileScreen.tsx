...
export const ProfileScreen: React.FC = () => {
  ...
  const skillsConfig: {
    ...
    {
      key: 'analysis',
      labelRu: 'Распознавание паттернов & Анализ',
      icon: LineChart,
      color: 'text-cyan-400',
    ...
    {
      key: 'discipline',
      labelRu: 'Дисциплина & Следование правилам',
      icon: Shield,
    ...
    },
    {
      ...
      descriptionRu: 'Устойчивость к FOMO, сериям стопов и эйфории после тейк-профитов.',
    },
    {
      key: 'strategy',
  ...
  const handleUpgrade = (skillKey: SkillKey) => {
    ...
    <div className="h-full flex flex-col justify-between overflow-y-auto p-3 sm:p-4 max-w-5xl mx-auto w-full select-none pb-2">
      ...
      <div className="bg-[#091522] border border-cyan-500/30 rounded-2xl p-4 shadow-xl flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div className="flex items-center gap-3.5">
          <div className="relative w-16 h-16 rounded-2xl bg-gradient-to-tr from-cyan-500 to-emerald-400 p-0.5 shadow-lg shadow-cyan-950/60">
        ...
        {activeTab === 'skills' && (
          <div className="space-y-3">
            <div className="flex items-center justify-between text-xs text-slate-400 pb-2 border-b border-white/5 font-mono">
              <span>Паутинная прокачка профиля</span>
