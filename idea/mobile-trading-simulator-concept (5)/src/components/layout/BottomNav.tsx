...
const SECONDARY_NAV: NavItem[] = [
  { id: 'admin', labelRu: 'Admin CRM & LiveOps', icon: Cpu, badge: 'ADMIN', badgeColor: 'bg-red-500' },
  { id: 'journal', labelRu: 'Журнал Ошибок', icon: Scroll, badge: 'DQI', badgeColor: 'bg-pink-500' },
  { id: 'tournaments', labelRu: 'Колизей & Турниры', icon: Trophy, badge: 'LIVE', badgeColor: 'bg-amber-500' },
  { id: 'story', labelRu: 'Нарратив (Хроники)', icon: Scroll },
  { id: 'social', labelRu: 'Лига Аналитиков', icon: Trophy },
  { id: 'guild', labelRu: 'Гильдия & Чат', icon: Users },
  { id: 'stats', labelRu: 'Аналитика DQI', icon: BarChart3 },
